...
# sd of pca       loading       mean      standard daviation          pcm


head(prin_comp$rotation, 5)
...
#this whole data after doing pca 
prin_comp$x


#This is the data we are looking for after doing pca 

data <-prin_comp$x[,1:15]
